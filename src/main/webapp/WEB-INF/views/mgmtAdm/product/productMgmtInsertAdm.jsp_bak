...
<div id="productModal" tabindex="-1" aria-hidden="true" data-modal-backdrop="static" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto h-[calc(100%-1rem)] max-h-full bg-black/50">
                ...
                <div class="p-6 grid grid-cols-12 gap-6">
                    ...
                    <div class="col-span-12 md:col-span-6 space-y-4">
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            <div><label class="text-[11px] font-bold">API GRV</label><input type="number" id="apiGrv" class="w-full border rounded p-1 text-sm"></div>
                            <div><label class="text-[11px] font-bold">Sulfur(%)</label><input type="number" id="sulfurPCnt" class="w-full border rounded p-1 text-sm"></div>
                            <div><label class="text-[11px] font-bold">Flash Pt</label><input type="number" id="flashPnt" class="w-full border rounded p-1 text-sm"></div>
                            <div><label class="text-[11px] font-bold">Viscosity</label><input type="number" id="viscosity" class="w-full border rounded p-1 text-sm"></div>
                            <div><label class="text-[11px] font-bold">Density 15C</label><input type="number" id="density15c" class="w-full border rounded p-1 text-sm"></div>
                        </div>
                        <div>
