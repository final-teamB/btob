            ...
            <table class="min-w-full leading-normal">
                <thead>
                    <tr class="bg-gray-50 dark:bg-gray-700 text-gray-500 dark:text-gray-400 text-xs font-bold uppercase tracking-wider">
                        ...
                        <th class="px-5 py-3 border-b border-gray-100 dark:border-gray-700 text-left">총 금액</th>
                        <th class="px-5 py-3 border-b border-gray-100 dark:border-gray-700 text-center">비우기</th>
                    </tr>
                </thead>
