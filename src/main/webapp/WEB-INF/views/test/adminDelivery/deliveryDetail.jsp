            ...
            <tr>
                ...
                <td>
                    <select id="deliveryStatus">
                        <option value="READY" ${deliveryDTO.deliveryStatus == 'READY' ? 'selected' : ''}>상품준비중</option>
                        <option value="L_SHIPPING" ${deliveryDTO.deliveryStatus == 'L_SHIPPING' ? 'selected' : ''}>국내배송중</option>
                        <option value="D_SHIPPING" ${deliveryDTO.deliveryStatus == 'D_SHIPPING' ? 'selected' : ''}>배송중</option>
                        <option value="COMPLETE" ${deliveryDTO.deliveryStatus == 'COMPLETE' ? 'selected' : ''}>배송완료</option>
                    </select>
                </td>
                <th>운송장번호</th>
